...
interface TaxProps {
  setTaxVisible: (visible: boolean) => void;
}

const Tax: React.FC<TaxProps> = ({ setTaxVisible }) => (
  <Box w="900px" h="770px" mt={-550} ml={400} border="none" borderRadius="12px" bgColor="#FFFFFF">
